...
| [day 3](https://adventofcode.com/2023/day/3)   | [` 0.020 ms`](./day03a/src/main.rs) | [` -.--- ms`](./day03b/src/main.rs) |

|              | one-by-one (1 CPU core)                  | parallel                                     |
|:-------------|:-----------------------------------------|:---------------------------------------------|
| _everything_ | [` 0.09 ms`](./runner/src/bin/runner.rs) | [` 0.09 ms`](./runner/src/bin/runner-par.rs) |
